...
| [**CVE-2025-44823**](https://nvd.nist.gov/vuln/detail/CVE-2025-44823) | Authenticated API Key Exposure in Nagios Log Server | 9.9 | Critical | [💥](https://github.com/skraft9/CVE-2025-44823)
| [**CVE-2026-25769**](https://nvd.nist.gov/vuln/detail/CVE-2026-25769) | Authenticated Remote Code Execution via Insecure Deserialization in Wazuh Cluster | 9.1 | Critical | [💥](https://github.com/wazuh/wazuh/security/advisories/GHSA-3gm7-962f-fxw5)
| [**CVE-2026-25770**](https://nvd.nist.gov/vuln/detail/CVE-2026-25770) | Privilege Escalation to Root via Cluster Protocol File Write in Wazuh Cluster | 9.1 | Critical | [💥](https://github.com/wazuh/wazuh/security/advisories/GHSA-r4f7-v3p6-79jm)
| [**CVE-2026-25771**](https://nvd.nist.gov/vuln/detail/CVE-2026-25771) | Unauthenticated Denial of Service in Wazuh API | 5.3 | Medium | [💥](https://github.com/wazuh/wazuh/security/advisories/GHSA-33w3-p5hm-jw7g)
...
- **Product Security** – Discovered and reported vulnerabilities in Elastic software. Ranked #10 on the Elastic all-time leaderboard on HackerOne. Ranked #1 on the 2026 Elastic leaderboard.

<img width="2939" height="1191" alt="image" src="https://github.com/user-attachments/assets/6fedbad8-8c8c-43be-a471-2f3d8fccc64d" />
